...
import tivingLogo from '../../img/1695032536_1.svg';
import backimg from '../../img/6u5x4l6u5x4l6u5x.png';
import './Header.css';
      ...
      <div className="header-container">
        <div className="top-box">
          <ul className="tbox01">
            <li>
              <Link to="/">
                <img src={tivingLogo} alt="tving logo" />
              </Link>
            </li>
            <li>
              <Link to="/Section">드라마</Link>
            </li>
            <li>
              <Link to="/">예능</Link>
            </li>
          ...
          <ul className="tbox02">
            ...
            <li>
              <Link to="/LoginPages">로그인</Link>
            </li>
            {/* <li><img src="img/vpace.jpg" alt="" /></li> */}
          </ul>
        </div>
        <div className="centerbox">
          <img src={backimg} alt="poster" />
        </div>
